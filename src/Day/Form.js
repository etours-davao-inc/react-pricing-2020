...
export default ({ k }) => {
  ...
  return (
    <form className="form-inline" onSubmit={onSubmit}>
      ...
      <select id="type" className="custom-select mr-1" onChange={onChange} >
      ...
      <input type="number" step="any" name="price" placeholder="0.0" className="form-control mr-2 text-right" onChange={onChange}  />
      <div className="form-group mr-2">
        <div className="form-check">
          <input type="checkbox" id="shared" name="shared" className="form-check-input" onChange={onChange}  />
          <label htmlFor="shared" className="form-check-label">Shared</label>
        </div>
      </div>
      <div className="form-group mr-2">
        <div className="form-check">
          <input type="checkbox" id="vat" name="vat" className="form-check-input" onChange={onChange} />
          <label htmlFor="vat" className="form-check-label">Vat</label>
        </div>
      </div>
      <div className="form-group mr-2">
        <div className="form-check">
          <input type="checkbox" id="coh" name="coh" className="form-check-input" onChange={onChange} />
